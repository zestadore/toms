...
class AvailabilityController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $data= Availability::query()->join('quote_revisions','availabilities.quote_revision_id','quote_revisions.id')->join('quotations','quote_revisions.quotation_id','quotations.id')-> select(['availabilities.*','quotations.*','quote_revisions.rev_id','availabilities.id as availability_id','availabilities.status as availablity_status']);
