...
@extends('layouts.app')
    ...
    @section('breadcrump')
        ...
        <div class="col-sm-6">
            ...
            <li class="breadcrumb-item"><a href="{{route('admin.hotels.addons.index',$hotel_id)}}">Addons</a></li>
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card card-default color-palette-box">
                    ...
                    <div class="card-body">
                        <form action="{{route('admin.hotels.addons.update',[$hotel_id,$data->id])}}" method="post" id="addNewForm">@csrf
                            @method('put')
                            <div class="row">
