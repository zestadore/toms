        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card card-default color-palette-box">
                    ...
                    <div class="card-body">
                        <form action="{{route('admin.hotels.date-plans.update',[$hotel_id,$data->id])}}" method="post" id="addNewForm">@csrf
                            @method('put')
                            <div class="row">
    ...
    @section('scripts')
        ...
        <script>
            ...
            $('#valid_from').datetimepicker({
                format: 'L',
                defaultDate:  new Date('{{Carbon::parse($data->valid_from)->format("m-d-Y")}}')
            });
            $('#valid_to').datetimepicker({
                format: 'L',
                defaultDate:  new Date('{{Carbon::parse($data->valid_to)->format("m-d-Y")}}')
            });

            function prefillForm(){
                $('#valid_from').val('{{Carbon::parse($data->valid_from)->format("m-d-Y")}}');
