        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card card-default color-palette-box">
                    ...
                    <div class="card-body">
                        <form action="{{route('admin.hotels.update',$data->id)}}" method="post" id="addNewForm" enctype='multipart/form-data'>@csrf
                            @method('put')
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2bs4" name="destination_id" id="destination_id" style="width: 100%;" required>
                                          ...
                                          @foreach ($destinations as $item)
                                              <option value="{{$item->id}}" @if (Crypt::decrypt($item->id)==$data->destination_id)
                                                  selected="selected" 
                                              @endif>{{$item->destination}}</option>
                                          @endforeach
                                        </select>
