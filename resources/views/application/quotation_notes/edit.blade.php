@extends('layouts.app')
    ...
    @section('breadcrump')
        ...
        <div class="col-sm-6">
            ...
            <li class="breadcrumb-item"><a href="{{route('admin.quotation-notes.index')}}">Notes</a></li>
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card card-default color-palette-box">
                    ...
                    <div class="card-body">
                        <form action="{{route('admin.quotation-notes.update',$data->id)}}" method="post" id="addNewForm">@csrf
                            @method('put')
                            <div class="row">
