                ...
                <div class="card card-default color-palette-box">
                    ...
                    <div class="card-body">
                        <form id="filterfordatatable" class="form-horizontal" onsubmit="event.preventDefault();">
                            <div class="row ">
                                <div class="col">
                                    <input type="text" name="search" class="form-control" placeholder="Search with bank name">
                                </div>
                            </div>
                        </form><br>
    ...
    @section('scripts')
        ...
        <script>
            ...
            function editData(id){
                var url="{{route('admin.banks.edit','ID')}}";
            ...
            function deleteData(id)
            {
                ...
                dangerMode: true,
                    ...
                    if (result) {
                        var url="{{route('admin.banks.destroy','ID')}}";
                        url=url.replace('ID',id);
                        $.ajax({
                            url: url,
                            type:"delete",
            ...
            $('#add-new').click(function(){
                window.location.href="{{route('admin.banks.create')}}";
            });
